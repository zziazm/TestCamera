...
// ARGB Offset Helpers
NSUInteger alphaOffsetNew(NSInteger x, NSInteger y, NSUInteger w, NSUInteger h)
{
    x = x < 0 ? 0 : x;
    x = x >= w ? w -1: x;
    y = y < 0 ? 0 : y;
...
NSUInteger redOffsetNew(NSInteger x, NSInteger y, NSUInteger w, NSUInteger h)
{
    x = x < 0 ? 0 : x;
    x = x >= w ? w -1: x;
    y = y < 0 ? 0 : y;
...
NSUInteger greenOffsetNew(NSInteger x, NSInteger y, NSUInteger w, NSUInteger h)
{
    x = x < 0 ? 0 : x;
    x = x >= w ? w -1: x;
    y = y < 0 ? 0 : y;
...
NSUInteger blueOffsetNew(NSInteger x, NSInteger y, NSUInteger w, NSUInteger h)
{
    x = x < 0 ? 0 : x;
    x = x >= w ? w -1: x;
    y = y < 0 ? 0 : y;
